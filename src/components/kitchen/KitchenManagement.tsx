  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-stone-200 bg-white p-5 shadow-sm sm:p-6">
        <div><p className="text-xs font-bold uppercase tracking-[0.18em] text-emerald-700">Delivery controls</p><h2 className="mt-1 text-xl font-black text-stone-900">Slot capacity</h2><p className="mt-1 text-sm text-stone-500">Capacity means thali portions per delivery window. Cutoffs stay fixed at 10:30 AM for lunch and 5:30 PM for dinner.</p></div>
      ...
      <section className="rounded-3xl border border-stone-200 bg-white p-5 shadow-sm sm:p-6">
        <div className="flex items-start gap-3"><Users className="mt-1 shrink-0 text-emerald-700" /><div><p className="text-xs font-bold uppercase tracking-[0.18em] text-emerald-700">Access control</p><h2 className="mt-1 text-xl font-black text-stone-900">Kitchen staff</h2><p className="mt-1 text-sm text-stone-500">Add an existing TEFFEIN account by email. Access changes take effect on the user's next role refresh or sign-in.</p></div></div>
